...
public class Config {
    ...
    public static final String MCPATCHER_JSON = "mcpatcher.mixins.json";
    ...
    /**
     * Gets a value from mcpatcher.mixins.json.
     *
    ...
    /**
     * Sets a value in mcpatcher.mixins.json.
     *
     * @param mod   name of mod
     * @param tag   property name
    ...
    /**
     * Remove a value from mcpatcher.mixins.json.
     *
     * @param mod name of mod
     * @param tag property name
     */
