...
class MobRuleList {
    ...
    private MobRuleList(ResourceLocation baseSkin) {
        ...
        String newPath = baseSkin.getResourcePath().replaceFirst("^textures/entity/", TexturePackAPI.MCPATCHER_SUBDIR + "mob/");
        ...
        ResourceLocation altFilename = new ResourceLocation(newSkin.getResourceDomain(), filename.getResourcePath().replaceFirst(ALTERNATIVES_REGEX, ".properties"));
