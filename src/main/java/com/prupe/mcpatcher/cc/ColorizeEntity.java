...
public class ColorizeEntity {
    private static final ResourceLocation LAVA_DROP_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/lavadropcolor.png");
    private static final ResourceLocation MYCELIUM_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/myceliumparticlecolor.png");
    private static final ResourceLocation XPORB_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/xporbcolor.png");
