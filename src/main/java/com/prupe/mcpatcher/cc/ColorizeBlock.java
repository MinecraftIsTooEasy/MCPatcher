...
public class ColorizeBlock {
    ...
    private static final ResourceLocation PUMPKIN_STEM_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/pumpkinstemcolor.png");
    private static final ResourceLocation MELON_STEM_COLORS = TexturePackAPI.newMCPatcherResourceLocation("/misc/melonstemcolor.png");
    private static final ResourceLocation SWAMPGRASSCOLOR = TexturePackAPI.newMCPatcherResourceLocation("/misc/swampgrasscolor.png");
    private static final ResourceLocation SWAMPFOLIAGECOLOR = TexturePackAPI.newMCPatcherResourceLocation("/misc/swampfoliagecolor.png");
    private static final ResourceLocation DEFAULT_GRASSCOLOR = new ResourceLocation("/misc/grasscolor.png");
    private static final ResourceLocation DEFAULT_FOLIAGECOLOR = new ResourceLocation("/misc/foliagecolor.png");
    private static final ResourceLocation PINECOLOR = TexturePackAPI.newMCPatcherResourceLocation("/misc/pinecolor.png");
    private static final ResourceLocation BIRCHCOLOR = TexturePackAPI.newMCPatcherResourceLocation("/misc/birchcolor.png");
    private static final ResourceLocation WATERCOLOR = TexturePackAPI.newMCPatcherResourceLocation("/misc/watercolorX.png");
    ...
    private static String getDefaultBlockName(ResourceLocation resource) {
        return resource.getResourceDomain() + ":" + resource.getResourcePath().replaceFirst(".*/", "").replaceFirst("\\.[^.]*$", "");
    }
