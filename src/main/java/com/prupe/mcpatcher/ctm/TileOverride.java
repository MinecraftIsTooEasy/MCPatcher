...
abstract class TileOverride implements ITileOverride {
    ...
    protected TileOverride(PropertiesFile properties, TileLoader tileLoader) {
        ...
        String texturesDirectory = properties.getResource().getResourcePath().replaceFirst("/[^/]*$", "");
        baseFilename = properties.getResource().getResourcePath().replaceFirst(".*/", "").replaceFirst("\\.properties$", "");
