...
public class FontUtils {
    ...
    public static ResourceLocation getFontName(FontRenderer fontRenderer, ResourceLocation font, float hdFontAdj) {
        jss.notfine.util.FontRendererExpansion expansion = ((jss.notfine.util.FontRendererExpansion) fontRenderer);
    ...
    public static float[] computeCharWidthsf(FontRenderer fontRenderer, ResourceLocation filename, BufferedImage image,
        ...
        if (!((jss.notfine.util.FontRendererExpansion) fontRenderer).getIsHD()) {
    ...
    private static float getCharWidthf(FontRenderer fontRenderer, char ch) {
        ...
        if (width < 0 || ((jss.notfine.util.FontRendererExpansion) fontRenderer).getCharWidthf() == null
                || ch >= ((jss.notfine.util.FontRendererExpansion) fontRenderer).getCharWidthf().length) {
            return width;
        } else {
            return ((jss.notfine.util.FontRendererExpansion) fontRenderer).getCharWidthf()[ch];
        }
    }

    public static float getCharWidthf(FontRenderer fontRenderer, int[] charWidth, int ch) {
        return ((jss.notfine.util.FontRendererExpansion) fontRenderer).getIsHD()
                ? ((jss.notfine.util.FontRendererExpansion) fontRenderer).getCharWidthf()[ch] * fontRenderer.FONT_HEIGHT / 8.0f
                : (float) charWidth[ch];
    }
