...
//import mitemod.mcpatcher.Texture;
...
//    }
//
//    public static void setupTexture(TextureManager renderEngine, BufferedImage image, int glTextureId, boolean blur, boolean clamp, ResourceLocation textureName) {
//        if (image != null) {
//            int width = image.getWidth();
//            int height = image.getHeight();
//            int[] rgb = MCPatcherUtils.getImageRGB(image);
//            GLAPI.glBindTexture(glTextureId);
//            MipmapHelper.setupTexture(rgb, width, height, 0, 0, blur, clamp, textureName.getResourcePath());
//        }
//    }
//
